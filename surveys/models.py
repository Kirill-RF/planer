...
# === Модели (оставляем существующие + добавляем новые) ===
...
class Question(models.Model):
    ...
    question_type = models.CharField(max_length=20, choices=QUESTION_TYPES, verbose_name=None)
...
# === УТИЛИТЫ НОРМАЛИЗАЦИИ (оставляем, нужны для Excel) ===
